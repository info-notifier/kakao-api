...
//        private val spy2 = spy(MetaDataDAO(ObjectMapper()))
...
////            given(metaDataDAOMock.getMetaData("C1")).willReturn(spy2.getMetaData("C1"))
////            given(repo.metaDataDAO).willReturn(spy2)
//
//
...
//            // given(crawler.vacancy).willReturn(foo) 로 하면
